      ...
      <div style={{
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                background: 'none',
                border: 'none',
                borderBottom: tab === key ? `2px solid ${BRAND.brown}` : '2px solid transparent',
                marginBottom: -1,
                fontSize: 14,
                fontWeight: tab === key ? 600 : 400,
                color: tab === key ? BRAND.brown : BRAND.textMuted,
                cursor: 'pointer',
              }}
            >
              {label}
        ...
        {tab === TAB.PASSWORD && (
          <form onSubmit={handlePasswordLogin}>
            ...
            <p style={{ marginTop: 14, fontSize: 12, color: BRAND.textMuted, textAlign: 'center' }}>
              No password yet? Use the <button onClick={() => setTab(TAB.MAGIC)} style={{ background: 'none', border: 'none', color: BRAND.burgundy, fontSize: 12, cursor: 'pointer', padding: 0 }}>email link</button> tab to log in, then set one in your profile.
            </p>
          </form>
        )}
